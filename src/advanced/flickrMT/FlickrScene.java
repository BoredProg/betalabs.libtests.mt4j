                        ...
                        flickrButton.addGestureListener(TapProcessor.class, new IGestureEventListener()
                        {
                            ...
                            public boolean processGestureEvent(MTGestureEvent ge)
                            {
						        ...
						        /*
                                        ...
                                        String flickrApiKey = "a53ced580648efdd3e8c5fd90a5e94f8";
                                        String flickrSecret = "7a620ccadf5a7aa7";
                                        ...
                                        try
                                        {
                                            ...
                                            flickrApiKey = "a53ced580648efdd3e8c5fd90a5e94f8"; //properties.getProperty("FlickrApiKey", " ");
                                            flickrSecret = "7a620ccadf5a7aa7";  //properties.getProperty("FlickrSecret", " ");
                                        }
                                        catch (Exception e)
                                        {
