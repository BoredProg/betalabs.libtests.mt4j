                            ...
                            public boolean processGestureEvent(MTGestureEvent ge)
                            {
						        ...
						        /*
                                        ...
                                        try
                                        {
                                            ...
                                            try
                                            {
                                                in = new FileInputStream("advanced" + AbstractMTApplication.separator + "flickrMT" + AbstractMTApplication.separator + "data" + AbstractMTApplication.separator + "FlickrApiKey.txt");
                                            } catch (Exception e)
                                            {
