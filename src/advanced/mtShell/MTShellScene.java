...
import advanced.widgets.carousel.CarouselScene;
import basic.mtGestures.MTGesturesExampleScene;
import basic.scenes.Scene1;
import basic.svgExample.SVGScene;
import gov.pnnl.components.visibleComponents.widgets.piano.MusicScene;
import gov.pnnl.components.visibleComponents.widgets.radialMenu.examples.MTRadialMenuExampleScene;
import org.mt4j.MTApplication;
import org.mt4jx.components.visibleComponents.layout.test.SimpleLayoutTestSceneScene;
...
//		listHeight = app.width - 50;
        ...
        /*
         * //List ends fade images //Background gradient has to be set to
         * false!
         * PImage gradImage = app.loadImage(this.getPathToIcons() +
         * "gradx3.png");
         ...
         *
         * MTRectangle grad2 = new MTRectangle(0, listHeight-gradImage.height ,
         * gradImage.width, gradImage.height, app);
         * grad2.rotateZ(grad2.getCenterPointLocal(), 180,
        ...
        this.addScene(new ICreateScene()
        {
            public Iscene getNewScene()
            {
                return new MTRadialMenuExampleScene((MTApplication) app, "Radial Menu Scene");
            }

            public String getTitle()
            {
                return "Radial Menu Scene";
            }
        ...
        this.addScene(new ICreateScene()
        {
            public Iscene getNewScene()
            {
                ...
                return new advanced.simpleParticles.ParticleTestScene(app, "Simple Particles Drawing");
            }
        ...
        this.addScene(new ICreateScene()
        {
            public Iscene getNewScene()
            {
                return new Scene1(app, "Scene Transitions Scene");
            }
        ...
        }, app.loadImage(this.getPathToIcons() + "transitions.png"));
        ...
        this.addScene(new ICreateScene()
        {
            public Iscene getNewScene()
            {
                return new SimpleLayoutTestSceneScene((MTApplication)app, "Layout Scene");
            }
        ...
        }, app.loadImage(this.getPathToIcons() + "layout.png"));        
        ...
        this.addScene(new ICreateScene()
        {
            public Iscene getNewScene()
            {
                return new CarouselScene((MTApplication)app, "Carousel Scene");
            }

            public String getTitle()
            {
                return "Carousel Scene";
            }
        }, app.loadImage(this.getPathToIcons() + "carousel.png"));                
        ...
        this.addScene(new ICreateScene()
        {
            public Iscene getNewScene()
            {
                return new MusicScene((MTApplication)app, "Music Scene");
            }
        ...
        }, app.loadImage(this.getPathToIcons() + "piano.png"));                
        ...
        cell.addGestureListener(TapProcessor.class, new IGestureEventListener()
        {
            public boolean processGestureEvent(MTGestureEvent ge)
            {
                ...
                if (te.isTapped())
                {
                    ...
                    if (!switchDirectlyToScene)
                    {//We have FBO support -> show scene in a window first
...
//		*/
         ...
         *
         * MTRectangle reflectionRect = new MTRectangle(0, height, width,
         * height, getMTApplication());
         * reflectionRect.setTexture(reflection);
         * reflectionRect.setUseDirectGL(true);
         * //	reflectionRect.setNoStroke(true);
         * reflectionRect.rotateZ(rect.getCenterPointLocal(), 90,
         * TransformSpace.LOCAL);
         *
         * cell.addChild(rect);
         ...
         * reflectionRect.translate(new Vector3D(realListCellWidth - topShift -
         * icon.height - gapBetweenIconAndReflection, 0));
         *
         * cell.setAnchor(oldCellAnchor);
         *
         * //	rect.setPositionRelativeToParent(cell.getCenterPointLocal());
         *
         * //	MTRoundRectangle r = new MTRoundRectangle(0, 0, 0, listCellWidth,
         * listCellHeight, 30, 30, getMTApplication());
         * //	cell.addChild(r);
         *
